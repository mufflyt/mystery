...
acog_districts_df <- data.frame(
  ...
  ACOG_District = c(
    "District VII", "District VIII", "District VIII", "District VII", "District IX",
...
us_census_bureau_regions_df <- data.frame(
  ...
  Region = c(
    "West", "South", "South", "West", "West", "West", "Northeast", "South", "South",
  ...
  Division = c(
    "Pacific", "East South Central", "West South Central", "Mountain", "Pacific", "Mountain",
